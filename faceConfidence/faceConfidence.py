...
cnn_face_detector = dlib.cnn_face_detection_model_v1('faceConfidence/mmod_human_face_detector.dat')

def confidence_score(file_name):
        ...
        for i, d in enumerate(dets):
            ...
            r.append(confidence)
            # if(d.confidence >= 0.8):
            #   cv2.imwrite('perfectImages/' + str(a) + ".jpg",img1)
            #   print("Save it")
