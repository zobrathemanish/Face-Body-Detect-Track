...
def draw_box_label(id,img, bbox_cv2, box_color=(0, 255, 255), show_label=True):
    ...
    if show_label:
        ...
        if((bottom > 1042) and (bottom) < 1050):
            ...
            folder = os.path.exists(str(id))

            if(folder == False):

                os.makedirs(str(id))

            image_path = str(id) + '/' + str(time.time()) + ".jpg"
            ...
            try:
                ...
                with open("ramlal.txt", "a") as myfile:
                    print("Writing the intended text")
                    myfile.write(str(id) + str(ages) + "\n") 
                ...
                with open("ramlal.txt", "a") as myfile:
                    print("Writing the unintended text")
                    myfile.write(str(id) + "Low resolution \n") 
